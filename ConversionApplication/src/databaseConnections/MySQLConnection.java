...
public class MySQLConnection {
	...
	/**
	 * Konstruktor sa svim podacima za MySQL bazu
	 * 
	 * @param dB_URL
	 * @param nazivBaze
	 * @param uSER
	 * @param pASS
	 */
	public MySQLConnection(String DB_URL, String nazivBaze, String USER, String PASS) {
		super();
		this.DB_URL = DB_URL;
	...
	/**
	 * Funkcija koja vraæa listu svih indeksa sa svim stupcima koje MySQL vraæa
	 * 
	 * @param nazivTablice
	 * @return
	 * @throws SQLException
